...
/// Minimal fake that never makes network calls.
...
void main() {
  group('PrayerRepositoryImpl', () {
    ...
    test('getDailyStatus returns default prayers on error', () async {
      final prayers = await repository.getDailyStatus();
      expect(prayers, isA<List<Prayer>>());
    });
  });
}